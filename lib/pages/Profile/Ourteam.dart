...
import 'package:singlerestaurant/Model/settings%20model/ourteammodel.dart';
                        ...
                        Padding(
                          ...
                          child: Row(
                            ...
                            children: [
                              ...
                              InkWell(
                                onTap: () {
                                  _launchURL(ourteamdata!.data![index].insta);
                                },
                                child: Image(
                              ...
                              InkWell(
                                onTap: () {
                                  _launchURL(ourteamdata!.data![index].youtube);
                                },
                                child: Image(
                                  image: const AssetImage(
