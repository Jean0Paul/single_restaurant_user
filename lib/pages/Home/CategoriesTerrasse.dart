...
class Terrassepage extends StatefulWidget {
  List<Categories>? categoriesdata;

  @override
  State<Terrassepage> createState() => _TerrassepageState();
  Terrassepage([this.categoriesdata]);
}

class _TerrassepageState extends State<Terrassepage> {
  @override
